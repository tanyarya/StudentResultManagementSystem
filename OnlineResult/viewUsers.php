...
<link href="viewUsers.css" rel="stylesheet" type="text/css" />
</head>
...
<tr class="labels" style="text-decoration:underline;color:#EA8BAC;"><th>Sr.No.</th><th>Roll No.</th><th>Name</th><th>Email</th><th>Delete</th></tr>
<?php 
$i=1;
...
{
	?>
<tr class="labelss" style="font-size:15px;color:#fdf1cb;text-align:center;">
<td><?php echo $i;$i++;?></td>
